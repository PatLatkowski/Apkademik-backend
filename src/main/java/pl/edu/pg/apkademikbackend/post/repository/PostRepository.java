...
public interface PostRepository extends JpaRepository<Post,Integer> {
    ...
    public Integer getPage(@Param("noticeBoard") long noticeBoard);
    ...
    public List<Post> findAllByDateAndPage(@Param("noticeBoard") long noticeBoard,@Param("page") Integer page);


    @Query(value = "select count(id) from post as c  where c.notice_board_id= :noticeBoard ", nativeQuery = true)
    public Integer countPosts(@Param("noticeBoard") long noticeBoard);
